...
//    }
    ...
    private func configureInputFields() {
        firstNameInput.configure(with: .init(text: RegistrationTexts.firstName, width: view.width * 0.8, height: 50))
        lastNameInput.configure(with: .init(text: RegistrationTexts.lastName, width: view.width * 0.8, height: 50))
        emailInput.configure(with: .init(text: RegistrationTexts.email, width: view.width * 0.8, height: 50))
        passwordInput.configure(with: .init(text: RegistrationTexts.password, width: view.width * 0.8, height: 50))
    }
